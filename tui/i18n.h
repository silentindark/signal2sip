...
enum class Key {
    ...
    DetailTitlebar, FooterConfigureSip, FooterDisable, FooterEnable,
    ...
    WizardVerify, FieldSmsCode, FooterTypeCode, FooterConfirmCode,
...
inline constexpr const char* kTable[kKeyCount][kLangCount] = {
    ...
    /* FooterSelect */ {" ↑↓ select  ", " ↑↓ вибір  ", " ↑↓ выбор  ", " ↑↓ wybór  ", " ↑↓ auswählen  ",
                         " ↑↓ sélection  ", " ↑↓ seleziona  ", " ↑↓ seleccionar  ", " ↑↓ selecionar  "},
    /* FooterDetails */ {"↵ details  ", "↵ деталі  ", "↵ детали  ", "↵ szczegóły  ", "↵ Details  ",
                          "↵ détails  ", "↵ dettagli  ", "↵ detalles  ", "↵ detalhes  "},
    /* FooterNew */ {"n new  ", "n новий  ", "n новый  ", "n nowe  ", "n neu  ", "n nouveau  ", "n nuovo  ",
                      "n nuevo  ", "n novo  "},
    /* FooterRefresh */ {"r refresh  ", "r оновити  ", "r обновить  ", "r odśwież  ", "r aktualisieren  ",
                          "r actualiser  ", "r aggiorna  ", "r actualizar  ", "r atualizar  "},
    /* FooterQuit */ {"q quit  ", "q вихід  ", "q выход  ", "q wyjście  ", "q beenden  ", "q quitter  ",
                       "q esci  ", "q salir  ", "q sair  "},
    ...
    /* FooterConfigureSip */ {" c configure SIP  ", " c налаштувати SIP  ", " c настроить SIP  ",
                               " c konfiguruj SIP  ", " c SIP konfigurieren  ", " c configurer SIP  ",
                               " c configura SIP  ", " c configurar SIP  ", " c configurar SIP  "},
    /* FooterDisable */ {"d disable  ", "d вимкнути  ", "d выключить  ", "d wyłącz  ", "d deaktivieren  ",
                          "d désactiver  ", "d disabilita  ", "d deshabilitar  ", "d desabilitar  "},
    /* FooterEnable */ {"d enable  ", "d увімкнути  ", "d включить  ", "d włącz  ", "d aktivieren  ",
                         "d activer  ", "d abilita  ", "d habilitar  ", "d habilitar  "},
    ...
    /* FooterBack */ {"esc back  ", "esc назад  ", "esc назад  ", "esc wstecz  ", "esc zurück  ", "esc retour  ",
                       "esc indietro  ", "esc atrás  ", "esc voltar  "},
    ...
    /* ConfirmAccountLabel */ {"Account: ", "Акаунт: ", "Аккаунт: ", "Konto: ", "Konto: ", "Compte : ",
                                "Account: ", "Cuenta: ", "Conta: "},
    /* FooterCancel */ {"esc cancel  ", "esc скасувати  ", "esc отмена  ", "esc anuluj  ", "esc abbrechen  ",
                         "esc annuler  ", "esc annulla  ", "esc cancelar  ", "esc cancelar  "},
    /* EnterDelete */ {"enter delete", "enter видалити", "enter удалить", "enter usuń", "enter löschen",
                        "entrée supprimer", "invio elimina", "enter eliminar", "enter excluir"},
    ...
    /* FooterConfirm */ {"y confirm  ", "y підтвердити  ", "y выполнить  ", "y potwierdź  ", "y bestätigen  ",
                          "y confirmer  ", "y conferma  ", "y confirmar  ", "y confirmar  "},
    /* ErrSipHostRequired */
    ...
    /* FooterField */ {" ↑↓/tab field  ", " ↑↓/tab поле  ", " ↑↓/tab поле  ", " ↑↓/tab pole  ",
                        " ↑↓/tab Feld  ", " ↑↓/tab champ  ", " ↑↓/tab campo  ", " ↑↓/tab campo  ",
                        " ↑↓/tab campo  "},
    /* FooterTextType */ {"text: type  ", "текст: вводьте  ", "текст: вводите  ", "tekst: wpisz  ",
                           "Text: eingeben  ", "texte : saisissez  ", "testo: digita  ", "texto: escriba  ",
                           "texto: digite  "},
    /* FooterListCycles */ {"list: ↵ cycles  ", "список: ↵ перемикає  ", "список: ↵ переключает  ",
                             "lista: ↵ przełącza  ", "Liste: ↵ wechselt  ", "liste : ↵ change  ",
                             "elenco: ↵ cambia  ", "lista: ↵ cambia  ", "lista: ↵ alterna  "},
    /* FooterSave */ {"^O save  ", "^O зберегти  ", "^O сохранить  ", "^O zapisz  ", "^O speichern  ",
                       "^O enregistrer  ", "^O salva  ", "^O guardar  ", "^O salvar  "},
    /* FooterFieldPlain */ {" ↑↓ field  ", " ↑↓ поле  ", " ↑↓ поле  ", " ↑↓ pole  ", " ↑↓ Feld  ",
    ...
    /* FooterToggleMethod */ {"↵ toggle method  ", "↵ перемкнути спосіб  ", "↵ переключить способ  ",
                               "↵ przełącz metodę  ", "↵ Methode wechseln  ", "↵ changer de méthode  ",
                               "↵ cambia metodo  ", "↵ cambiar método  ", "↵ alternar método  "},
    /* FooterNext */ {"^O next  ", "^O далі  ", "^O далее  ", "^O dalej  ", "^O weiter  ", "^O suivant  ",
                       "^O avanti  ", "^O siguiente  ", "^O próximo  "},
    ...
    /* FooterToggleCodeMethod */ {"↵ toggle code method  ", "↵ перемкнути спосіб коду  ",
                                   "↵ переключить способ кода  ", "↵ przełącz metodę kodu  ",
                                   "↵ Code-Methode wechseln  ", "↵ changer la méthode du code  ",
                                   "↵ cambia metodo del codice  ", "↵ cambiar método del código  ",
                                   "↵ alternar método do código  "},
    /* FooterRegister */ {"^O register  ", "^O зареєструвати  ", "^O зарегистрировать  ", "^O zarejestruj  ",
                           "^O registrieren  ", "^O inscrire  ", "^O registra  ", "^O registrar  ",
                           "^O registrar  "},
    /* WizardResult */ {"result: ", "результат: ", "результат: ", "wynik: ", "Ergebnis: ", "résultat : ",
                         "risultato: ", "resultado: ", "resultado: "},
    /* FooterEnterCode */ {"v enter code  ", "v ввести код  ", "v ввести код  ", "v wpisz kod  ",
                            "v Code eingeben  ", "v saisir le code  ", "v inserisci codice  ",
                            "v ingresar código  ", "v inserir código  "},
    /* FooterToList */ {"esc to list  ", "esc до списку  ", "esc к списку  ", "esc do listy  ",
                         "esc zur Liste  ", "esc vers la liste  ", "esc alla lista  ", "esc a la lista  ",
                         "esc para a lista  "},
    /* CaptchaInstructions */
    ...
    /* FooterSubmit */ {"^O submit  ", "^O надіслати  ", "^O отправить  ", "^O wyślij  ", "^O senden  ",
                         "^O envoyer  ", "^O invia  ", "^O enviar  ", "^O enviar  "},
    ...
    /* FooterConfirmCode */ {"^O confirm  ", "^O підтвердити  ", "^O подтвердить  ", "^O potwierdź  ",
                              "^O bestätigen  ", "^O confirmer  ", "^O conferma  ", "^O confirmar  ",
                              "^O confirmar  "},
    ...
    /* FooterCancelWaiting */ {" esc cancel waiting ", " esc скасувати очікування ", " esc отменить ожидание ",
                                " esc anuluj oczekiwanie ", " esc Warten abbrechen ", " esc annuler l'attente ",
                                " esc annulla attesa ", " esc cancelar espera ", " esc cancelar espera "},
